...
void setup() {
  ...
  OTA_menu.addItem("WiFi settings", ezWifiMenu);
...
void OTA_demo() {
  ...
  if (ez.msgBox("Get M5ez demo program", "This will download and replace the current sketch with the M5ez demo program.", "Cancel#OK#") == "OK") {
    ...
    if (ez.update("https://raw.githubusercontent.com/ropg/M5ez/master/compiled_binaries/M5ez-demo.bin", root_cert, &progress_bar)) {
