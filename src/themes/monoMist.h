...

{
	...
	theme.name = "monoMist";									// Change this when making theme
	theme.displayName = "mono Mist";							// Change this when making theme
	...
	theme.button_bgcolor_b = TFT_BLACK;
	theme.button_bgcolor_t = TFT_BLACK;
	theme.button_fgcolor = TFT_YELLOW;
	theme.button_longcolor = TFT_GREEN;
